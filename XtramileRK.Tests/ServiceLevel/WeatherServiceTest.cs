...
namespace XtramileRK.Tests.ServiceLevel
{
    ...
    public class WeatherServiceTest
    {
        ...
        {
            WeatherResponse weatherResponse = await _weatherService.GetWeatherInfoAsync("London", "GB").ConfigureAwait(false);
        ...
        public async Task Weather_Info_Should_Be_Error_When_Api_Key_Is_Invalid()
        {
            ...
            IWeatherService _invalidWeatherService = new FakeWeatherService("12345");
            WeatherResponse weatherResponse = await _invalidWeatherService.GetWeatherInfoAsync("London", "GB").ConfigureAwait(false);
        ...
        public async Task Weather_Info_Should_Be_Error_When_Api_Key_Is_Not_Set()
        {
            ...
            IWeatherService _invalidWeatherService = new FakeWeatherService(null);
            WeatherResponse weatherResponse = await _invalidWeatherService.GetWeatherInfoAsync("London", "GB").ConfigureAwait(false);
